...
if (CMAKE_CXX_COMPILER)
  ...
  check_cxx_source_compiles("static long long ll; int main(int, char**) { return ll; }" HAS_LONG_LONG)
  if (HAS_LONG_LONG)
    add_definitions(-DPN_CPP_HAS_LONG_LONG=1)
  endif()
  check_cxx_source_compiles("#include <memory>\nstatic std::shared_ptr<int> i; static std::unique_ptr<int> u; int main(int, char**) { return 0; }" HAS_STD_PTR)
  if (HAS_STD_PTR)
